...
echo "   Web UI URL:     http://localhost:8080 (or https://argocd.ariphmohd.shop)"
echo "   Admin Username: admin"
echo "   Temp Password:  ${ARGOCD_PASSWORD}"
echo "   -----------------------------------------------------------------"
echo "   🔒 SECURITY: Update your password on first login and delete the bootstrap secret:"
echo "   👉 In Web UI:   Click User Info -> 'Update Password'"
echo "   👉 Or via CLI:  argocd account update-password"
echo "   👉 Cleanup:     kubectl -n argocd delete secret argocd-initial-admin-secret"
echo "================================================================="
echo ""
