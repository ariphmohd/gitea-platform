...
echo "   URL:            http://localhost:3001 (or https://grafana.ariphmohd.shop)"
echo "   Username:       ${GRAFANA_ADMIN_USER}"
echo "   Get Password:   kubectl -n monitoring get secret grafana-admin-credentials -o jsonpath=\"{.data.admin-password}\" | base64 -d && echo"
echo ""
echo "3. ☕ Gitea Web UI:"
echo "   Port-Forward:   kubectl port-forward svc/gitea-http -n gitea 3000:3000"
echo "   URL:            http://localhost:3000 (or https://gitea.ariphmohd.shop)"
echo "   Username:       gitea_admin"
echo "   Get Password:   kubectl -n gitea get secret gitea-admin-secret -o jsonpath=\"{.data.password}\" | base64 -d && echo"
echo ""
