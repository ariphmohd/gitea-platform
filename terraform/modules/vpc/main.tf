...
# Private Subnets (for EKS Worker Nodes and EFS Mount Targets)
...
# Database Subnets (for RDS PostgreSQL)
...
resource "aws_db_subnet_group" "main" {
  ...
  description = "Database subnet group for Gitea RDS PostgreSQL"
